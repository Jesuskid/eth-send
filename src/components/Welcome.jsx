...
const Welcome = () => {
    ...
    const handleSubmit = (e) => {
        ...
        e.preventDefault()
        console.log(`from welcome ${formData.addressTo}`)
    ...
    return (
        <div className="flex w-full justify-center items-center">
            <div className="flex mf:flex-row
            flex-col items-start justify-between md:p-20 py-12 px-4
            ">
                <div className="flex flex-1 justify-start
                flex-col mf:mr-10
                ">
                    <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
                        Send Crypto <br /> Generate an  Meme
                    </h1>
                    <p className="text-left mt-5 text-white font-light
                    md:w-9/12 w-11/12 text-base
                    ">
                        Send eth to other accounts on the chains and generate a unique transaction gif
                    </p>
                    ...
                    ">
                        ...
                        <div className={`rounded-tl-2xl ${commonStyles}`}>Goerli</div>
                        <div className={`${commonStyles}`}>Binance testnet</div>
                        <div className={`rounded-tr-2xl ${commonStyles}`}>Polygon(Mumbai)</div>
                        <div className={`rounded-bl-2xl ${commonStyles}`}>Low Fees</div>
                        <div className={`${commonStyles}`}>Easy</div>
                        <div className={`rounded-br-2xl ${commonStyles}`}>Fun
                        </div>
                    </div>
                </div>
